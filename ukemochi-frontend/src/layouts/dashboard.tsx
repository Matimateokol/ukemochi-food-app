...
export const DashboardLayout = () => {
  ...
  return (
    <div className="w-full h-full bg-stone-200 overflow-x-hidden">
      <div className="h-[60px] md:h-[80px] bg-zinc-100 flex items-center justify-between px-3 sticky top-0 z-50">
        <div className="flex items-center">
          <h2 className="text-slate-600 font-bold text-xl underline-offset-4 underline">
            <NavLink to="/dashboard">Ukemochi</NavLink>
          </h2>
          <span className="text-orange-400 font-extrabold text-xl pl-2">.</span>
        </div>
      ...
      <div className="flex flex-col md:flex-row w-full h-full z-10 relative">
        <div className="hidden md:block bg-zinc-700 h-full w-[20%] fixed">
          <div className="md:flex gap-8 items-start w-full p-3">
            ...
            />
            <div>
              <p className="text-orange-400 font-light">{user}</p>
            </div>
          </div>
          <div className="flex flex-col gap-y-1  mt-3">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive && pathname === to
                    ? "text-white font-thin text-sm bg-orange-400 p-4"
                    : "text-white font-thin text-sm hover:bg-orange-400 p-4"
                }
              >
                {name}
              </NavLink>
            ...
            <Button
              ...
              className="text-white font-thin text-sm text-left hover:bg-orange-400 p-4"
            />
          </div>
        </div>
